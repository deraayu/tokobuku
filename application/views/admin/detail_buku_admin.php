			...
			<div class="row">
				...
				<div class="col-md-8">
					<table class="table">
						<tr>
							<td>Kode Buku</td>
							<td><strong><?php echo $bk->kd_buku ?></strong></td>
						</tr>
						...
						<tr>
							<td>Gambar</td>
							<td><strong><?php echo $bk->gambar ?></strong></td>
						</tr>
						<tr>
							<td>Stock</td>
						...
						<tr>
							...
							<td><strong><div class="btn btn-sm btn-success">Rp. <?php echo number_format($bk->harga,0,',','.') ;?> </div></strong></td>
					          ...
					          <?php echo anchor('admin/data_buku','<div class="btn btn-sm btn-danger">kembali</div>') ?>
